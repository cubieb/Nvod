...
#ifndef NVOD_SERVICE_ODB_H
#define NVOD_SERVICE_ODB_H
...
namespace odb
{
    ...
    public access::object_traits< ::ReferenceServiceEvent >
  {
    ...
    struct image_type
    {
      ...
      // startTimePoint
      //
      long long startTimePoint_value;
  ...
  struct pointer_query_columns< ::TimeShiftedServiceEvent, id_mysql, A >
  {
    ...
    static const refsEvent_type_ refsEvent;
  };
  ...
  template <typename A>
  const typename pointer_query_columns< ::TimeShiftedServiceEvent, id_mysql, A >::refsEvent_type_
  pointer_query_columns< ::TimeShiftedServiceEvent, id_mysql, A >::
  refsEvent (A::table_name, "`RefsEventIdx`", 0);
    ...
    public access::object_traits< ::TimeShiftedServiceEvent >
  {
    ...
    struct image_type
    {
      ...
      // refsEvent
      //
      unsigned int refsEvent_value;
      my_bool refsEvent_null;
    ...
    query_columns_base< ::TimeShiftedServiceEvent, id_mysql >
  {
    ...
    odb::query_pointer<
      odb::pointer_query_columns<
        ...
        id_mysql,
        refsEvent_alias_ > >
    refsEvent_pointer_type_;

    struct refsEvent_type_: refsEvent_pointer_type_, refsEvent_column_type_
    {
      refsEvent_type_ (const char* t, const char* c, const char* conv)
        : refsEvent_column_type_ (t, c, conv)
      {
      }
    };
  ...
  template <typename A>
  const typename query_columns< ::TimeShiftedServiceEvent, id_mysql, A >::refsEvent_type_
  query_columns< ::TimeShiftedServiceEvent, id_mysql, A >::
  refsEvent (A::table_name, "`RefsEventIdx`", 0);
}

#include "NvodService-odb.ixx"

#include <odb/post.hxx>

#endif // NVOD_SERVICE_ODB_H
